...
| Frontend modules, AIO workflows and translations | Pending | Pending |
| MQTT transport, diagnostics and HA entities | Pending | Pending |
| Privileges, updater and Debian packaging | In progress | Installer rewrite removed; package verifier added |
| Event journal, performance and release automation | Pending | Pending |
